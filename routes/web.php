...
Route::get('/report/edit/{report}', [ReportController::class, 'edit'])->middleware(['auth', 'verified'])->name('report.edit');
Route::put('/report/update/{report}', [ReportController::class, 'update'])->middleware(['auth', 'verified'])->name('report.update');
